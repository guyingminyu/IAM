...
urlpatterns = [
    ...
    re_path(r'add_project_task$',views.add_project_task),
    re_path(r'edit_project_task/?$',views.edit_project_task),
    re_path(r'set_task_status/?$',views.set_task_status),
    re_path(r'del_project_task/?$',views.del_project_task),
    re_path(r'task_add/(?P<pid>\d+)/(?P<tid>\d+)/?$',views.add_task_page),
    re_path(r'get_task_cases$',views.get_task_cases),
    re_path(r'add_task_cases$',views.add_task_cases),
    re_path(r'del_task_case/?$',views.del_task_case),
    re_path(r'run_task/?$',views.run_task),
    re_path(r'task_detail/(?P<pid>\d+)/(?P<tid>\d+)/?$',views.task_detail_page),
    re_path(r'get_task_logs/?$',views.get_task_logs),
    re_path(r'search_task_logs/?$',views.search_task_logs),
    re_path(r'task_report_detail/(?P<pid>\d+)/(?P<tid>\d+)/(?P<tlid>\d+)/?$',views.task_report_detail_page),
    re_path(r'get_task_report_logs/?$',views.get_task_report_logs),
    re_path(r'get_task_report_log_detail/?$',views.get_task_report_log_detail),
